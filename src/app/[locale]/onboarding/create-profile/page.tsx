                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                     ...
                                     <div>
                                        <Label>Visa Status (Optional)</Label>
                                        <Select name="visaStatus" value={formState.visaStatus} onValueChange={(value) => handleSelectChange('visaStatus', value)}>
                                            <SelectTrigger><SelectValue placeholder="Select visa status..." /></SelectTrigger>
                                            <SelectContent>
                                                <SelectItem value="citizen">Citizen</SelectItem>
                                                <SelectItem value="permanent-resident">Permanent Resident (PR)</SelectItem>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            <Label>Family Details / Background (Optional)</Label>
                                            <Textarea 
                                                name="familyBackground" 
                                                placeholder="Tell us more about your family (siblings, parents' professions, etc.)" 
                                                value={formState.familyBackground} 
