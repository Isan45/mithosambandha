  ...
  >
      ...
      <ul className="space-y-4">
        {features.map((feature, index) => {
          const isExcluded =
            ...
            Array.isArray(feature.props.children)
              ? feature.props.children.some(
                  (child: React.ReactNode) => React.isValidElement(child) && child.type === XCircle
                )
              : false;
          ...
          const isStar =
            ...
            Array.isArray(feature.props.children)
              ? feature.props.children.some(
                  (child: React.ReactNode) => React.isValidElement(child) && child.type === Star
                )
              : false;
    ...
    <CardFooter className="mt-auto">
      {plan === 'Free' ? (
        ...
        <CheckoutButton plan={plan as 'Gold' | 'Platinum'} price={price} />
      )}
    </CardFooter>
  </Card>
);
