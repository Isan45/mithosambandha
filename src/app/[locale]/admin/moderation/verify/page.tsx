          ...
          {pendingProfiles.map((user) => {
            ...
            <Card key={user.uid}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <h4 className="font-semibold text-sm mb-1">Visa Status</h4>
                                <p className="text-sm text-muted-foreground">{profile.visaStatus || 'N/A'}</p>
                            </div>
                            <div>
                                <h4 className="font-semibold text-sm mb-1">Family Type</h4>
                                <p className="text-sm text-muted-foreground">{profile.familyType || 'N/A'}</p>
                            </div>
                        </div>
                        <div>
                            <h4 className="font-semibold text-sm mb-1">Family Background</h4>
                            <p className="text-xs text-muted-foreground italic">{profile.familyBackground || 'N/A'}</p>
                        </div>
                    </div>
                     <div className="space-y-6">
                        <div>
              ...
              <CardFooter className="flex justify-end gap-2 border-t pt-4 mt-4">
                  <UserActions uid={user.uid} currentStatus={user.profileStatus} />
              </CardFooter>
            </Card>
          )})}
        </div>
